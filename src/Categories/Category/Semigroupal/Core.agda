...
module Categories.Category.Semigroupal.Core {o ℓ e} (C : Category o ℓ e) where
...
record Semigroupal : Set (o ⊔ ℓ ⊔ e) where
  infixr 10 _⊗₀_ _⊗₁_
...
monoidalHelper : Semigroupal′ → Semigroupal
